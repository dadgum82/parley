# This should fix the Sequence table issues
...
INSERT INTO chat_rooms_users (chat_room_id, user_id)
VALUES (3, 1);
-- Waffles INSERT INTO chat_rooms_users (chat_room_id, user_id) VALUES (3, 2); -- Luna INSERT INTO chat_rooms_users (chat_room_id, user_id) VALUES (3, 3); -- Spike INSERT INTO chat_rooms_users (chat_room_id, user_id) VALUES (3, 4); -- Koshka INSERT INTO chat_rooms_users (chat_room_id, user_id) VALUES (3, 5); -- Muffins INSERT INTO chat_rooms_users (chat_room_id, user_id) VALUES (3, 6); -- Jesse INSERT INTO chat_rooms_users (chat_room_id, user_id) VALUES (3, 7); -- Bryan INSERT INTO chat_rooms_users (chat_room_id, user_id) VALUES (3, 8);
-- Jason
...
-- Create Chat Room for Emoji Testing
INSERT INTO chat_rooms (id, icon_path, moderator_id, name)
...
# ALTER TABLE chat_rooms AUTO_INCREMENT=1000;
# ALTER TABLE chat_messages AUTO_INCREMENT=1000;
# ALTER TABLE chat_rooms_users AUTO_INCREMENT=1000;